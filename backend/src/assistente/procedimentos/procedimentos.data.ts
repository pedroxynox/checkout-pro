...
export const PROCEDIMENTOS: ProcedimentoGuiado[] = [
  {
    ...
    blocos: [
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/auditoria_de_cpf/01.jpg',
        w: 291,
        h: 153,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'Definir o processo de não inserção do CPF no próprio caixa.',
      },
      {
        tipo: 'texto',
        conteudo: '2. APLICAÇÃO',
      },
      {
        tipo: 'texto',
      ...
      {
        tipo: 'texto',
        conteudo: '4. ATRIBUIÇÕES E RESPONSABILIDADES',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'EXECUÇÃO DO PROCESSSO',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'auditoria de cadastros CRM – CPF de funcionário.;',
      },
      {
        tipo: 'texto',
        conteudo:
  ...
  },
  {
    ...
    blocos: [
      ...
      {
        tipo: 'texto',
        conteudo: 'VENDAMERC ADQU DE TERCEIRO) para casos específicos.',
      },
      {
        tipo: 'texto',
        conteudo: '2. APLICAÇÃO',
      ...
      {
        tipo: 'texto',
        conteudo: 'devolução e vale débitos.',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: '✓ Operação Frente de Caixa da Loja.',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: '✓ Código do cliente.',
      },
      {
        tipo: 'texto',
        conteudo: '✓ Nº da Loja que está sendo emitida a nota fiscal.',
      },
      {
        tipo: 'texto',
        conteudo: '✓ CGO: 680 (DEVOLUÇÃO-VENDAMERC ADQU DE TERCEIRO).',
      },
      {
        tipo: 'texto',
        conteudo: '✓ Data: Sempre deverá ser a data do dia atual.',
      },
      {
        tipo: 'texto',
        conteudo: '✓ Motivo da Devolução. (Flag).',
      },
      {
        tipo: 'texto',
      ...
      {
        tipo: 'texto',
        conteudo: 'pelos respectivos setores!',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'não vinculada a CTe/MDFe',
      },
      {
        tipo: 'texto',
        conteudo: 'ORIENTAÇÃO PARA EMISSÃO DA DEVOLUÇÃO:',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/01.jpg',
        w: 900,
        h: 352,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'Modulo Recebimento > Atacado/Varejo > Recebimento de Notas:',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/02.jpg',
        w: 717,
        h: 525,
      },
      {
        tipo: 'texto',
        conteudo: '• Realizar o preenchimento do cabeçalho:',
      },
      {
        tipo: 'texto',
        conteudo: '1° Data de saída (data do dia atual)',
      },
      {
        tipo: 'texto',
        conteudo: '2° Informar o CGO 680',
      },
      {
        tipo: 'texto',
        conteudo: '3° Selecionar o motivo da devolução',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/03.jpg',
        w: 900,
        h: 371,
      },
      {
        tipo: 'texto',
        conteudo: '4° Preencher no campo Forn. o código do cliente:',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/04.jpg',
        w: 900,
        h: 376,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'Clicar na opção Selec. Itens:',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/05.jpg',
        w: 900,
        h: 613,
      },
      {
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/06.jpg',
        w: 900,
        h: 487,
      },
      {
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/07.jpg',
        w: 900,
        h: 483,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'Nota fiscal para as notas emitidas no CGO 203.',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/08.jpg',
        w: 900,
        h: 501,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: '1° Inserir o número da Nota que será devolvida.',
      },
      {
        tipo: 'texto',
        conteudo: '2° Preencher o cód do cliente informado no cupom de venda:',
      },
      {
        tipo: 'texto',
        conteudo: '3° Clicar na Lupa para pesquisa',
      },
      {
        tipo: 'texto',
        conteudo: '4° Selecionar o documento abaixo encontrado',
      },
      {
        tipo: 'texto',
        conteudo: '5° Selecionar o Flag dos produtos a serem devolvidos',
      },
      {
        tipo: 'texto',
        conteudo: '6° Clicar na seta retornar',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/09.jpg',
        w: 900,
        h: 443,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'as demais informações desta tela.',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/10.jpg',
        w: 900,
        h: 514,
      },
      {
        tipo: 'texto',
        conteudo: 'Ajustar o Tipo Frete para Sem Ocorrência de Transporte:',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/11.jpg',
        w: 900,
        h: 608,
      },
      {
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/12.jpg',
        w: 900,
        h: 478,
      },
      {
        tipo: 'texto',
        conteudo: '• Lista de possíveis inconsistências e responsáveis:',
      },
      {
        tipo: 'texto',
        conteudo: '✓ Custo Líquido: Setor de Controladoria.',
      },
      {
        tipo: 'texto',
        conteudo: '✓ Impostos: Setor fiscal.',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'Nota, seguir os passos abaixo:',
      },
      {
        tipo: 'texto',
        conteudo: '1° Clicar em Liberar Nota',
      },
      {
        tipo: 'texto',
        conteudo: '2° Selecionar a Flag Emitir',
      },
      {
        tipo: 'texto',
        conteudo: '3° Clicar em Imprimir',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/13.jpg',
        w: 900,
        h: 478,
      },
      {
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/14.jpg',
        w: 900,
        h: 431,
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/15.jpg',
        w: 900,
        h: 476,
      },
      {
      ...
      {
        tipo: 'texto',
        conteudo: 'Fiscal Eletrônica”:',
      },
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/16.jpg',
        w: 690,
        h: 483,
      },
      {
      ...
      {
        tipo: 'imagem',
        imagem: '/assets/procedimentos/devolucao_680/17.jpg',
        w: 900,
        h: 411,
      },
    ],
  ...
  {
    id: 'emissao_de_danfes_ou_notas_fiscais',
    titulo: 'Procedimento Emissão Notas Fiscais Venda',
    palavrasChave: [
      'danfes',
      'emissao',
      'emissão',
    ...
    blocos: [
      ...
      {
        tipo: 'texto',
        conteudo: 'de emissão de notas fiscais nas lojas.',
      },
      {
        tipo: 'texto',
        conteudo: '2. APLICAÇÃO',
      ...
      {
        tipo: 'texto',
        conteudo: '3. SIGLAS E DEFINIÇÕES',
      },
      {
        tipo: 'texto',
        conteudo: '• NFE: Nota Fiscal Eletrônica',
      ...
      {
        tipo: 'texto',
        conteudo: 'responsabilidade pelo cumprimento dessas diretrizes.',
      },
      {
        tipo: 'texto',
        conteudo: 'EXECUÇÃO DO PROCESSSO',
      ...
      {
        tipo: 'texto',
        conteudo: 'TELEVENDAS — CGO 200, VENDA A CONTRIBUINTE PJ USO TELEV.',
      },
      {
        tipo: 'texto',
        conteudo: 'TELEVENDAS — CGO 202, VENDA A PJ NFe - TELEVNDAS',
      },
      {
        tipo: 'texto',
        conteudo: 'TELEVENDAS – CGO 212, VENDA A PJ ÓRGÃOS PUPLICOS TLV',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'E-COMMERCE — CGO 525, VENDA E-COMMERCE NFe,',
      },
      {
        tipo: 'texto',
        conteudo: 'E-COMMERCE — CGO 515, VENDA E-COMMERCE NFCe',
      },
      {
        tipo: 'texto',
        conteudo: 'E-COMMERCE — CGO 217, VENDA E-COM EXCLUSIVO LOJA 30',
      },
      {
        tipo: 'texto',
        conteudo: 'FRENTE CAIXA — CGO 500, NFe BASEADA NO CUPOM FISCA',
      },
      {
        tipo: 'texto',
        conteudo: 'VENDA SEBO — CGO 646, VENDA DE SEBO - PJ',
      },
      {
        tipo: 'texto',
        conteudo: 'DEVOLUÇÕES — CGO 650, DEVOLUÇÃO VENDA MERCADORIAS',
      },
      {
        tipo: 'texto',
        conteudo: 'VENDA RAPPI — CGO 201, VENDA A CONTRIBUINTE PJ (RAPPI)',
      },
      {
        tipo: 'texto',
        conteudo: 'DEVOLUÇÃO — CGO 218, DEVOLUÇÃO VENDA E-COMMERCE LOJA 30',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'DEVOLUÇÃO — CGO 516, DEVOLUÇÃO VENDA E-COMMERCE',
      },
      {
        tipo: 'texto',
        conteudo: 'DEVOLUÇÃO – CGO 680, DEVOLUÇÃO VENDA MERC ADQU DE TERCEIRO',
      },
      {
        tipo: 'texto',
        conteudo: 'INFORMAÇÕES COMPLEMENTARES:',
      ...
      {
        tipo: 'texto',
        conteudo: 'loja, pois refletiram nos resultados da mesma.',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'Receita Estadual - Consultas Contribuinte',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'forma o Setor Fiscal irá conseguir auxiliar de forma clara.',
      },
      {
        tipo: 'texto',
        conteudo: '➢ Mantendo sempre a cordialidade e o respeito.',
      },
      {
        tipo: 'texto',
  ...
  {
    id: 'utilizacao_de_terceiros_na_loja',
    ...
    blocos: [
      ...
      {
        tipo: 'texto',
        conteudo: 'operação de caixa aos domingos e feriados.',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'semana do mês até o dia 10 do mês seguinte;',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'faturamento por parte da empresa prestadora de serviço;',
      },
      {
        tipo: 'texto',
        conteudo:
      ...
      {
        tipo: 'texto',
        conteudo: 'do Gerente de Loja e Gerente de Operações Regional.',
      },
      {
        tipo: 'texto',
        conteudo:
  ...
  {
    id: 'alerta_de_filas',
    titulo: 'Alerta de Filas',
    palavrasChave: ['alerta', 'filas'],
    resumo:
      '1. OBJETIVO\nAlertar as lojas da rede sempre que houver formação de filas na frente de caixa, visando a rápida \natuação para reduzir o tempo de espera dos clientes e garantir a fluidez no atendimento.\n2. APLICAÇÃO\nEssa normativa aplica-se a todas as lojas da rede. A loja deve manter os Pontos de Venda (PDVs) \nabertos conforme a estimativa de vendas e a escala de trabalho. É de obrigatoriedade da loja ter a \nrelação dos operadores de supermercado que estão em outros setores para que no caso de fil',
    texto:
      '1. OBJETIVO\nAlertar as lojas da rede sempre que houver formação de filas na frente de caixa, visando a rápida \natuação para reduzir o tempo de espera dos clientes e garantir a fluidez no atendimento.\n2. APLICAÇÃO\nEssa normativa aplica-se a todas as lojas da rede. A loja deve manter os Pontos de Venda (PDVs) \nabertos conforme a estimativa de vendas e a escala de trabalho. É de obrigatoriedade da loja ter a \nrelação dos operadores de supermercado que estão em outros setores para que no caso de filas \nestejam sempre prontos para abrir os PDVs. \nRegra de Fila: sempre que houver um cliente sendo atendido no PDV e três ou mais \naguardando atendimento.\n3. EXECUÇÃO DO PROCESSO\nO Setor de Monitoramento será responsável pelo envio de alertas sempre que ocorrer a formação \nde filas na frente de caixa. O processo de alerta será realizado conforme o seguinte fluxo: \n \nPrimeiro Alerta: Será enviado para os Gerentes da loja sempre que houver um cliente sendo \natendido no PDV e dois ou mais aguardando atendimento. \nSegundo Alerta: Caso o problema persista por mais de 10 minutos após o primeiro alerta, o \nGerente de Operações Regional será notificado. \nTerceiro Alerta: Se, após 10 minutos do segundo alerta, a situação ainda não tiver sido resolvida, \no Gerente Executivo de Operações será informado.',
    blocos: [
      {
        tipo: 'texto',
        conteudo: '1. OBJETIVO',
      ...
      {
        tipo: 'texto',
        conteudo: '3. EXECUÇÃO DO PROCESSO',
      },
      {
        tipo: 'texto',
        conteudo:
  ...
  {
    id: 'presenca_fiscais',
    titulo: 'Presença de Fiscais nas Demarcações',
    palavrasChave: ['demarcações', 'fiscais', 'presença'],
    resumo:
      '1. OBJETIVO\nGarantir a presença de um líder ou fiscal de caixa nas áreas de checkout para promover o controle \noperacional, reforçar a segurança e inibir condutas ilícitas, assegurando um ambiente de \nconfiança para colaboradores e clientes. Essa prática visa prevenir fraudes, desvios de conduta e \nagilizar a resolução de incidentes que possam ocorrer nas lojas.\n2. APLICAÇÃO\nEsta normativa aplica-se a todas as lojas da rede, a presença do fiscal de caixa é obrigatória \ndurante todo o horário de ',
    texto:
      '1. OBJETIVO\nGarantir a presença de um líder ou fiscal de caixa nas áreas de checkout para promover o controle \noperacional, reforçar a segurança e inibir condutas ilícitas, assegurando um ambiente de \nconfiança para colaboradores e clientes. Essa prática visa prevenir fraudes, desvios de conduta e \nagilizar a resolução de incidentes que possam ocorrer nas lojas.\n2. APLICAÇÃO\nEsta normativa aplica-se a todas as lojas da rede, a presença do fiscal de caixa é obrigatória \ndurante todo o horário de funcionamento da loja, com especial atenção para os horários de pico e \nsituações de risco, como movimentação financeira elevada ou indícios de comportamentos \natípicos, seguir a demarcação na frente de caixa dos pontos onde o fiscal deverá permanecer, será \nde responsabilidade dos fiscais toda falta unitária ocasionada por descuido ou erro de processo. \n \n3. EXECUÇÃO DO PROCESSO\nO fiscal deverá permanecer nos pontos demarcados na loja, detectar e relatar qualquer \nirregularidade ou fraude, fiscalizar toda e qualquer compra, em casos de fardos (quantidade \nestabelecida pela empresa para liberação) ou eletrodomésticos o mesmo deverá ir no PDV \nrealizar a conferencia, e realizar o suporte necessário para os operadores. \nO Supervisor e líder da frente de caixa devem garantir que o processo seja seguido conforme \nnormas da empresa, assim como o Gerente da loja. \n \n4. PENALIDADE \n \nCaso o fiscal de caixa não cumpra com suas responsabilidades e não detecte fraude ou \nirregularidades, resultando em perdas financeiras, ele estará sujeito às seguintes penalidades: \n- Desconto no salário do fiscal de caixa, correspondente ao valor da perda financeira; \n- Treinamento adicional sobre procedimentos de fiscalização e controle; \n- Em casos graves ou reincidentes, pode ser aplicada pena de sansão disciplinar, suspensão ou \ndemissão.',
    blocos: [
      {
        tipo: 'texto',
        conteudo: '1. OBJETIVO',
