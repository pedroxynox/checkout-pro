...
describe('reset-operacional — testes de propriedade', () => {
  ...
  // apagar/conservar é disjunta e cobre exatamente as 17 entidades de movimento.
  // Validates: Requirements 2.1, 2.2, 2.3, 2.4, 2.5, 2.6, 2.7, 3.1, 3.2, 3.3, 3.4, 3.5, 8.4
  it('Property 2: partição disjunta e cobertura exata das 17 entidades de movimento', () => {
    fc.assert(
      fc.property(
