...
|---|---|---|---|---|
| Backend (`backend/src`) | 240 | 39793 | 113 | 19355 |
| Mobile (`mobile/src`) | 158 | 39673 | 28 | 3316 |
...
- **Backend:** 835 casos em 113 arquivos
- **Mobile:** 131 casos em 28 arquivos
- **Total:** 966 casos
...
- Áreas mobile documentadas: ver `docs/04-atlas-mobile/` (meta: 25).
