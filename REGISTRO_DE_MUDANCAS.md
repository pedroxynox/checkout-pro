...
- **Tocar no operador agora abre o perfil** dele (antes, tocar marcava falta).
- A **falta só é marcada/removida pelo botão "Falta"** — evita marcar falta sem
  querer.
- Novo botão **"Sem retorno"** (registra o não retorno do intervalo de hoje, sem
...
- Ambos aparecem só para quem gere ausências (`OPERADORES_AUSENCIAS`); em quem
  já está em falta, o botão vira "remover".
